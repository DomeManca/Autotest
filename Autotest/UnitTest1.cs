...
namespace Autotest
{
    public class UnitTest1
    {
        ...
        public void Test7()
        {
            ...
            v = new Vacanza("a123", 10, "bergamo", 2, true, 5);
            v.ModifyData(0, "bergamo", 2, true, 7);
            Assert.True(v.FlightCost == 7);
        }
        [Fact]
        public void Test8()
        {
        ...
        {
            v = new Vacanza("c789", 40, "roma", 8, false, 20);
            v.ChooseFlight(true, 0);
            Assert.True(v.IncludesFlight == true);
        }
        [Fact]
        public void Test11()
        {
        ...
        public void Test16()
        {
            ...
            Vacanza p = new Vacanza("ft12", 100, "catania", 40, true, 100);
        ...
        {
            v = new Vacanza("f12", 200, "catania", 40, true, 100);
            Vacanza p = new Vacanza("t12", 100, "catania", 40, true, 100);
